...
const RUNNER_CREDENTIALS = {
  email: 'riley.parker@ultracoach.dev', // Using Riley since Alex's password isn't working
  password: 'UltraCoach2025!',
  name: 'Riley Parker',
  userId: 'e3UoXVfa6uGTcRQ3KVOpCH2IkKUR4o1O',
}
...
test.describe('Message Features', () => {
  test('Workout context messaging', async ({ browser }) => {
    ...
    try {
      ...
      const workoutLinkButton = page.locator('button[aria-label*="workout"], button:has-text("Link")')
