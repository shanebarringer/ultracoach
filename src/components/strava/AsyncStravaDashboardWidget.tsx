...
interface AsyncStravaDashboardWidgetProps {
  className?: string
}
...
/**
 * Async Strava integration widget that uses Suspense
  ...
  return (
    <Card className={`h-fit ${className}`} data-testid="strava-dashboard-widget">
      ...
      <CardBody className="space-y-4">
        {!connectionStatus?.connected && !stravaState.connection?.isConnected ? (
...
AsyncStravaDashboardWidget.displayName = 'AsyncStravaDashboardWidget'

export default AsyncStravaDashboardWidget
