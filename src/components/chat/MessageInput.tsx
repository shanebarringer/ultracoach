        ...
        {messageInput.linkedWorkout && (
          <div className="relative">
            ...
            <Button
              ...
              className="absolute top-2 right-2 min-w-[44px] min-h-[44px] text-default-400 hover:text-default-600"
            >
              ×
            </Button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex items-end gap-2">
          <div className="flex-1 space-y-2">
            <Textarea
              ...
              classNames={{
                ...
                inputWrapper:
                  'min-h-[60px] bg-default-100 dark:bg-default-50 focus-within:ring-2 focus-within:ring-primary/20',
              }}
            />
          </div>
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="min-w-[44px] min-h-[44px] text-default-500 hover:text-primary-500"
            >
