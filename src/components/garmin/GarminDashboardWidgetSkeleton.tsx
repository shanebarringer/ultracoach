...
interface GarminDashboardWidgetSkeletonProps {
  className?: string
}

/**
 * Skeleton component for GarminDashboardWidget
 * Provides loading state that matches the actual component structure
 */
export function GarminDashboardWidgetSkeleton({
  className = '',
}: GarminDashboardWidgetSkeletonProps) {
  return (
    <Card className={`h-fit ${className}`} data-testid="garmin-dashboard-widget-skeleton">
      <CardHeader>
        <div className="flex justify-between items-center w-full">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 bg-default-200 rounded animate-pulse" />
            <div className="h-6 w-28 bg-default-200 rounded animate-pulse" />
          </div>
      ...
      <CardBody className="space-y-4">
        ...
        {/* Recent workouts section skeleton */}
        <div>
          <div className="flex justify-between items-center mb-3">
            <div className="h-4 w-28 bg-default-200 rounded animate-pulse" />
