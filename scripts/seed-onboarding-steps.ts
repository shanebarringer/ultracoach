...
const defaultOnboardingSteps = [
  ...
  // Step 4: Training Preferences
  {
    ...
    fields: [
      { name: 'preferredTimes', type: 'checkbox-group', label: 'Preferred Training Times', required: false },
      { name: 'preferredTerrain', type: 'checkbox-group', label: 'Preferred Terrain', required: false },
  ...
  // Step 5: Connections and Community
  {
    ...
    fields: [
      { name: 'connectionInterests', type: 'checkbox-group', label: 'Connection Interests', required: false },
