...
async function clearTestUsers() {
  ...
  try {
    ...
    const usersToDelete = await db
      .select({ id: schema.better_auth_users.id, email: schema.better_auth_users.email })
