...
echo ""
echo "📋 Step 1: Creating training plans with coach-runner relationships..."
...
echo ""
echo "🏃 Step 2: Creating workouts for all training plans..."
...
ON CONFLICT DO NOTHING;
" "Creating workouts for all training plans"

echo ""
echo "💬 Step 3: Creating conversations between coaches and runners..."
...
echo ""
echo "📨 Step 4: Adding initial welcome messages..."
...
SELECT 
    ...
    CASE 
        ...
        WHEN tp.title LIKE '%100%' THEN 'Ready for the 100-mile challenge? This is going to be an incredible journey. We''ll focus on building both physical and mental strength.'
...
echo "   • 80 workouts across all training plans (8 per plan)"
